(function () {
    ...
    d.helper.matchRecursiveRegExp = function (a, b, c, d) {
        ...
        function c() {
            ...
            l.extensions && d.helper.forEach(l.extensions, e)
        }
        ...
        function e(a, c) {
            ...
            for (var g = 0; g < a.length; ++g) {
                ...
                if (a[g].hasOwnProperty(o))for (var h in a[g].listeners)a[g].listeners.hasOwnProperty(h) && j(h, a[g].listeners[h])
            }
        }
        ...
        c(), this._dispatch = function (a, b, c, d) {
            ...
            return a = a.replace(/~/g, "~T"), a = a.replace(/\$/g, "~D"), a = a.replace(/\r\n/g, "\n"), a = a.replace(/\r/g, "\n"), l.smartIndentationFix && (a = k(a)), a = "\n\n" + a + "\n\n", a = d.subParser("detab")(a, l, b), a = d.subParser("stripBlankLines")(a, l, b), d.helper.forEach(m, function (c) {
                a = d.subParser("runExtension")(c, a, l, b)
            }), a = d.subParser("hashPreCodeTags")(a, l, b), a = d.subParser("githubCodeBlocks")(a, l, b), a = d.subParser("hashHTMLBlocks")(a, l, b), a = d.subParser("hashHTMLSpans")(a, l, b), a = d.subParser("stripLinkDefinitions")(a, l, b), a = d.subParser("blockGamut")(a, l, b), a = d.subParser("unhashHTMLSpans")(a, l, b), a = d.subParser("unescapeSpecialChars")(a, l, b), a = a.replace(/~D/g, "$$"), a = a.replace(/~T/g, "~"), d.helper.forEach(n, function (c) {
                a = d.subParser("runExtension")(c, a, l, b)
            }), a
            ...
            for (var b = 0; b < a.length; ++b) {
                ...
                for (var f = 0; f < n.length; ++e)n[f] === c && n[f].splice(e, 1)
            }
        ...
        var g = /\b(((https?|ftp|dict):\/\/|www\.)[^'">\s]+\.[^'">\s]+)(?=\s|$)(?!["<>])/gi, h = /<(((https?|ftp|dict):\/\/|www\.)[^'">\s]+)>/gi, i = /(?:^|\s)([A-Za-z0-9!#$%&'*+-\/=?^_`\{|}~\.]+@[-a-z0-9]+(\.[-a-z0-9]+)*\.[a-z]+)(?:$|\s)/gi, j = /<(?:mailto:)?([-.\w]+@[-a-z0-9]+(\.[-a-z0-9]+)*\.[a-z]+)>/gi;
        return a = a.replace(h, e), a = a.replace(j, f), b.simplifiedAutoLink && (a = a.replace(g, e), a = a.replace(i, f)), a = c.converter._dispatch("autoLinks.after", a, b, c)
        ...
        "use strict";
        return a = c.converter._dispatch("codeSpans.before", a, b, c), "undefined" == typeof a && (a = ""), a = a.replace(/(^|[^\\])(`+)([^\r]*?[^`])\2(?!`)/gm, function (a, b, c, e) {
            var f = e;
        ...
        var f = b.prefixHeaderId, g = isNaN(parseInt(b.headerLevelStart)) ? 1 : parseInt(b.headerLevelStart), h = b.smoothLivePreview ? /^(.+)[ \t]*\n={2,}[ \t]*\n+/gm : /^(.+)[ \t]*\n=+[ \t]*\n+/gm, i = b.smoothLivePreview ? /^(.+)[ \t]*\n-{2,}[ \t]*\n+/gm : /^(.+)[ \t]*\n-+[ \t]*\n+/gm;
        return a = a.replace(h, function (a, f) {
            var h = d.subParser("spanGamut")(f, b, c), i = b.noHeaderId ? "" : ' id="' + e(f) + '"', j = g, k = "<h" + j + i + ">" + h + "</h" + j + ">";
            return d.subParser("hashBlock")(k, b, c)
        }), a = a.replace(i, function (a, f) {
            var h = d.subParser("spanGamut")(f, b, c), i = b.noHeaderId ? "" : ' id="' + e(f) + '"', j = g + 1, k = "<h" + j + i + ">" + h + "</h" + j + ">";
            return d.subParser("hashBlock")(k, b, c)
        }), a = a.replace(/^(#{1,6})[ \t]*(.+?)[ \t]*#*\n+/gm, function (a, f, h) {
            var i = d.subParser("spanGamut")(h, b, c), j = b.noHeaderId ? "" : ' id="' + e(h) + '"', k = g - 1 + f.length, l = "<h" + k + j + ">" + i + "</h" + k + ">";
        ...
        function f(a, c, d) {
            ...
            return -1 !== a.search(h) ? !function j(a) {
                var b = a.search(h);
