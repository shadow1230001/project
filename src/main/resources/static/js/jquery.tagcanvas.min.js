 ...
 */
(function (ah) {
    var I, G, H = Math.abs, ab = Math.sin, u = Math.cos, q = Math.max, au = Math.min, ai = Math.ceil, B = Math.sqrt, ak = Math.pow, f = {}, h = {}, k = {
        0: "0,",
        1: "17,",
        2: "34,",
        3: "51,",
    ...
    M.Load = function () {
        var aH = this.GetTags(), aD = [], aG, aC, az, ay, j, aA, aF, aB = [], aE = {
            sphere: o,
            vcylinder: af,
            hcylinder: al,
            vring: c,
